                                ...
                                <TableCell className="text-right flex gap-5 items-center">
                                    {item?.status === "approved" ? (
                                        <>
                                            <Link
                                                to="#"
                                                className="bg-gray-400 p-2 rounded-[8px] cursor-not-allowed"
                                                onClick={(e) => e.preventDefault()}
                                            >
                                                <FaPenFancy className="text-3xl text-[#FAFAFA]" />
                                            </Link>
                                            <button
                                                className="bg-gray-400 p-2 rounded-[8px] cursor-not-allowed"
                                                onClick={(e) => e.preventDefault()}
                                            >
                                                <AiFillDelete className="text-3xl text-[#FAFAFA]" />
                                            </button>
                                        </>
                                    ) : (
                                        <>
                                            <Link
                                                to={`/dashboard/update-contest/${item._id}`}
                                                className="bg-red-600 p-2 rounded-[8px]"
                                            >
                                                <FaPenFancy className="text-3xl text-[#FAFAFA]" />
                                            </Link>
                                            <button
